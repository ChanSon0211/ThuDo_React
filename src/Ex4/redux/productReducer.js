const inititalState = {
    product : [
        ...
        },
        {
            ...
            name: "Top Cloth ",
            desc: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquid, nulla.",
            imgSrc_jpg: './images/18298964_39255833_600_show.jpg',
            imgSrc_png: './images//clothes/18298964_39255833_600_show.png',
        },
...
const reducer = (state = inititalState , action) => {
    switch(action.type){
        case 'CHANGE_TAB': {
console.log(action);
state.selecetedTab = action.payload 
return {...state}
